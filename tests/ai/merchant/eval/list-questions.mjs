 ...
 *
 *   node tests/ai/merchant/eval/list-questions.mjs          # readable list
 *   node tests/ai/merchant/eval/list-questions.mjs --json    # JSON array
 *
 * (The concierge eval has the same script.)
 */
